...
/**
 * 
 * TODO:(in order of priority)statuses, balance stuff, magic.
 *
 */
...
public class GameWorld {
	...
	public static void main(String[] args) {
		...
		Equipment woodArmor = new Equipment("armor", "Wood Armor", 60, 8, 0, "A wooden set of armor. It doesn't seem like it would offer much protection, but it'll do for smaller monsters.");
		Equipment bronzeArmor = new Equipment("armor", "Bronze Armor", 150, 15, 0, "A bronze set of armor. It seems to have seen it's fair share of battles.");
		Equipment silverArmor = new Equipment("armor", "Silver Armor", 200, 30, 0, "A gleaming set of silver armor. Smells like polish.");
		Equipment goldArmor = new Equipment("armor", "Gold Armor", 500, 60, 0, "A set of gold armor. Gold is too soft to make armor out of, so this armor set is actually titanium painted gold.");
		...
		Mob witchDoctor = new Mob("Witch Doctor", "Shaman", 10, 25, 1, 1, 8, 25, 20, 15);
		Mob manEatingPlant = new Mob("Man Eating Plant", null, 15, 30, 1, 3, 0, 30, 35, 25);
		...
		Mob koiDragon = new Mob("Koi Dragon", "Koifish", 15, 30, 1, 30, 1, 0, 50, 10);
